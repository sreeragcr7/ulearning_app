...
import 'package:ulearning_app/features/course/presentation/pages/course_details_page.dart';
  ...
  static Route<dynamic> onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case AppRoutes.courseDetails:
        ...
        return MaterialPageRoute(builder: (_) => CourseDetailsPage(courseId: courseId));
